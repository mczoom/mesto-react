...
function App() {
  ...
  return (
    <div className="page">
      <Header />
      <Main onEditProfile={editProfile} onAddPlace={addPlace} onEditAvatar={editAvatar} />
      ...
      <PopupWithForm title="Новое место" name="add-item" isOpen={isAddPlacePopupOpen} onClose={closeAllPopups}>
          <div className="popup__section">
